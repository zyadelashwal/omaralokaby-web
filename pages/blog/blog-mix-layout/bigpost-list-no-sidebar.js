...
const BigPostNoSidebarList = ({ }) => (
    <>
        <CommonLayout pathList={['blog', 'blog mix layout', 'list full width no sidebar']} pathTitle="BLOG WITH no-SIDEBAR">
                                ...
                                {BlogsList.length > 0 ?
                                    BlogsList.map((item, index) =>
                                        <CardWrapper
                                            ...
                                            className="col-12 blog-sec blog-list p-0"
                                            image={item.image}
...
export default BigPostNoSidebarList;