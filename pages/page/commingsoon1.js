...
const Commingsoon1 = () => (
    <section className="coming-soon p-0">
        <Container fluid={true} className="p-0">
            <Row className="text-center">
                <Col md="6" className="p-0 set-bg-img">
                    <div className="bg-coming-soon"></div>
                </Col>
                <Col md="6" className="bg-black">
                    <div className="center-container">
                        <div>
                            ...
                            <h6 className="launch-text">TIME LEFT UNTIL LAUNCHING</h6>
                            ...
                            <div className="center-content">
                                <FormGroup className='form-group'>
                                    <div className="d-flex">
                                        <Input className="form-control rounded-0" name="email"
                                            placeholder="Email Address" type="email" />
                                        <div className="button-primary">
                                            <button className=" btn btn-default primary-btn rounded-0 no-border"
                                                type="submit">
                                                subscribe
                                            </button>
                                        </div>
