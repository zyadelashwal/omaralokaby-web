                    ...
                    <Col lg="6">
                        ...
                        <div className="typography-box">
                            ...
                            <div className="typo-content">
                                <p className="text-start">This is a left aligned text .text-start</p>
                                <p className="text-center">This is a center aligned text .text-center</p>
                                <p className="text-end">This is a right aligned text .text-end</p>
                            </div>
                        </div>
                        <div className="typography-box">
                            <div className="headings">
                            ...
                            <div className="typo-content lists">
                                <Row>
                                    ...
                                    <Col sm="6">
                                        <h6 className="sub-title">order list</h6>
                                        <ul className="m-0">
                                            <li><i className="fa fa-angle-double-right me-2"></i>Lorem ipsum dolor sit amet</li>
                                            <li><i className="fa fa-angle-double-right me-2"></i>Lorem ipsum dolor sit amet</li>
                                            <li><i className="fa fa-angle-double-right me-2"></i>Lorem ipsum dolor sit amet</li>
                                            <li><i className="fa fa-angle-double-right me-2"></i>Lorem ipsum dolor sit amet</li>
                                            <li><i className="fa fa-angle-double-right me-2"></i>Lorem ipsum dolor sit amet</li>
                        ...
                        <div className="typography-box">
                            ...
                            <div className="typo-content typo-buttons">
                                <a className="btn btn-default primary-btn me-3 mt-1" href="#">button</a>
                                <a className="btn btn-default btn-gradient me-3 mt-1" href="#">button</a>
                                <a className="btn btn btn-default primary-btn rounded-0 me-3 mt-1" href="#">button</a>
                                <a className="btn btn-default back-white mt-1" href="#">button</a>
                            </div>
                        </div>
                    </Col>
                    <Col lg="6">
                            ...
                            <div className="typo-content">
                                <div className="socials-lists">
                                    <ul className="socials-horizontal justify-content-center">
                                        <li>
                                            <a href="https://www.facebook.com/"><i aria-hidden="true" className="fa fa-facebook center-content"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://twitter.com/"><i aria-hidden="true" className="fa fa-twitter center-content"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://accounts.google.com/"><i aria-hidden="true" className="fa fa-google center-content"></i></a>
                                        </li>
                                        <li>
                                            <a href="https://www.instagram.com/"><i aria-hidden="true" className="fa fa-instagram center-content"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
