                        ...
                        <div className="logo-sec">
                            ...
                            <div className="footer-contant">
                                ...
                                <div className="footer-para">
                                    <h6 className="text-white para-address">Omar Al-okaby</h6>
                                    <h6 className="text-white para-address">Egypt , Portsaid </h6>
        ...
        <div className="gym copyright">
            <Container>
                <Row>
                    ...
                    <Col sm="6">
                        <div>
                            <h6 className="copyright-text text-white text-end op-text">Copyright © 2023  Omar Al-okaby <i
                                    aria-hidden="true" className="fa fa-heart"></i> </h6>
                        </div>
                    </Col>
                </Row>
            </Container>
