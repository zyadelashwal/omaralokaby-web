            ...
            <Row>
                ...
                <Col xl="8" className="offset-xl-2">
                    <div className="testimonial-contain">
                        <Row>
                            <Col md="8" className="offset-md-2 ps-md-0">
                                        ...
                                        <div className="testimonial-right">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1">
                                                    <h5>fcastillo18</h5>
                                                    Dominican Republic, Member since February 2022
                                            </div>
                                            </div>
                                    ...
                                    <div>
                                        <div className="testimonial-right">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1">
                                                    <h5>drinkstuff</h5>
                                                    United Kingdom, Member since April 2022
                                            </div>
                                            </div>
